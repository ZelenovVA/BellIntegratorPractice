...
____
## :heavy_check_mark: Операции над данными организаций:
____
...
____
## :heavy_check_mark: Операции над данными офисов:
____
...
____
## :heavy_check_mark: Операции над данными пользователей:
____
...
____
## :heavy_check_mark: Справочники.
____

### Справочник гражданств.
Содержит в себе список кодов государств и соответствующих данному коду названий государств. Доступен по адресу */api/countries*.
...
Содержит в себе список кодов документов, удостоверяющих личность пользователя и соответствующих данному коду названий документов. Доступен по адресу */api/docs*.
